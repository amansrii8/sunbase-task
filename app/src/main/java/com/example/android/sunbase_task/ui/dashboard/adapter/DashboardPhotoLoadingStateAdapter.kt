package com.example.android.sunbase_task.ui.dashboard.adapter
...
import com.example.android.sunbase_task.databinding.NetworkStateItemBinding


class DashboardPhotoLoadingStateAdapter(private val retry: () -> Unit) :
    LoadStateAdapter<DashboardPhotoLoadingStateAdapter.LoadStateViewHolder>() {
